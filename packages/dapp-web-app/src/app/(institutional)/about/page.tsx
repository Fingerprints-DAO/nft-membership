      ...
      <Grid templateColumns="repeat(3, 1fr)" columnGap={20} rowGap={20}>
        ...
        <GridItem colSpan={{ base: 3, md: 1 }}>
          ...
          >
            ...
            <Text fontSize={'lg'}>
              ...
              as an input and produces a 3D structure that can be rendered or built in a variety of
              ways.
            </Text>
          </motion.div>
        </GridItem>
        <GridItem colSpan={{ base: 3, md: 1 }}>
          ...
          >
            ...
            <Text fontSize={'lg'}>
              Used as the governance standard for Fingerprints, Voxelglyph grants you access to our
              private community, special pricing in future FP Studio drops and many other perks of
              being a Fingerprints member.
            </Text>
          </motion.div>
        </GridItem>
        <GridItem colSpan={{ base: 3, md: 1 }}>
          ...
          >
            ...
            <Text fontSize={'lg'}>
              Not just an artwork itself, Voxelglyph grants you direct exposure to the Fingerprints
              treasury, including one of the most renowned blockchain art collections in the space.
              <br />
              <br />
              <Link
