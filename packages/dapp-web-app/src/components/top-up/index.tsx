      ...
      >
        ...
        {printsBalance.value.lte(BigNumber(0)) && (
          <Text fontSize="xs" color="secondary.500" mt={4}>
            You don&apos;t have any $PRINTS, which means you can acquire the NFT
            Membership directly on Opensea.
          </Text>
        )}
      </Box>
      <Box
      ...
      >
        <Flex>
          ...
          <Tooltip
            label={
              <Text>
                You could end up paying more than this amount due to pool
                slippage. Click details for more information.
              </Text>
            }
            fontSize="xs"
            color="gray.900"
